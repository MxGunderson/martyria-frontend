...
export const getPosts = () => dispatch => {
  ...
  axios
    .get('https://floating-fjord-69030.herokuapp.com/api/posts')
    .then(res =>
      dispatch({
        type: GET_POSTS,
        payload: res.data
...
export const addComment = (postId, commentData) => dispatch => {
  dispatch(clearErrors());
  axios
    .post(`https://floating-fjord-69030.herokuapp.com/api/posts/comment/${postId}`, commentData)
    .then(res =>
      dispatch({
        type: GET_POST,
        payload: res.data
...
export const deleteComment = (postId, commentId) => dispatch => {
  axios
    .delete(`https://floating-fjord-69030.herokuapp.com/api/posts/comment/${postId}/${commentId}`)
    .then(res =>
      dispatch({
        type: GET_POST,
        payload: res.data
